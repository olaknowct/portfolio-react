...
const Header = () => {
    return (
        <div className="header-nav">
            <a
                href="https://www.facebook.com/christopher.olano.1/"
                target="_blank"
            >
                <img className="nav-img fb" src="./img/facebook.png" alt="" />
            </a>
            <a href="https://github.com/olaknowct" target="_blank">
                <img className="nav-img github" src="./img/github.png" alt="" />
            </a>
            <a href="https://twitter.com/ola_knowsIt" target="_blank">
                <img className="nav-img twtr" src="./img/twitter.png" alt="" />
            </a>
            <a
                href="https://www.instagram.com/ola_knowsit/?hl=en"
                target="_blank"
            >
