...
class PortfolioPage extends React.Component {
            ...
            portfolios: [
                {
                    ...
                    gallery: [
                        ...
                        },
                        {
                            ...
                            description:
                                "Notification pop up when someone liked or commented",
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description:
                                "A messaging page where you can chat over with your selected friends",
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description:
                                "When someone requesting for a friend request",
                        },
                    ],
                ...
                },
                {
                    ...
                    gallery: [
                        ...
                        },
                        {
                            ...
                            description:
                                "this is where you select your choice of branch",
                        },
                        {
                            path: "./img/bookhub-gallery/4availablemovie.PNG",
                            description:
                                "list of available movie from the branch check into",
                        },
                        {
                            path: "./img/bookhub-gallery/5availablesched.PNG",
                            description:
                                "available schedule that based from selected branch and movie",
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description:
                                "navigation if loggedin as Administrator",
                        },
                        {
                        ...
                        {
                            path:
                                "./img/bookhub-gallery/12createshowbranch.PNG",
                            description:
                                "A branch is need when creating a show if you are an Administrator",
                        },
                        {
                            path:
                                "./img/bookhub-gallery/13createmovieadmin.PNG",
                            description:
                        ...
                        },
                        {
                            ...
                            description:
                                "This is where an Admin sees everything in his movie list",
                        },
                        {
                        ...
                        {
                            path:
                                "./img/bookhub-gallery/16coadmincreateshow.PNG",
                            description:
                                "Co-Administrator create show for his branch",
                        },
                        {
                            path:
                                "./img/bookhub-gallery/17successcreateshowcoadmin.PNG",
...

                {
                    ...
                    urlProject:
                        "https://olaknowsito.github.io/cps1_le_game/blurd.html",
                    demoVideo: {
                        isAvailable: false,
                        clipchamp: "https://clipchamp.com/watch/sYpbeA2kKFi",
                    },
                ...
                },
                {
                    ...
                    gallery: [
                        ...
                        {
                            path:
                                "./img/loyalwallet-gallery/4redeembydeducting.PNG",
                            description:
                                "Deducting points by means of Redeeming of   ",
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description:
                                "Updating of existing user information",
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description:
                                "a history of the points flow and summary table",
                        },
                        {
                ...
                },
                {
                    ...
                    urlProject:
                        "https://olaknowct.github.io/DOM-Bankist/index.html",
                    demoVideo: {
                        isAvailable: false,
                        clipchamp: "https://clipchamp.com/watch/sYpbeA2kKFi",
                    },
                    ...
                    gallery: [
                        {
                            ...
                            description:
                                "initial loading will ask your geolocation",
                        },
                        {
                ...
                },
                {
                    ...
                    gallery: [
                        ...
                        },
                        {
                            ...
                            description:
                                "Race Button is modified based from what is being set",
                        },
                        {
                            path: "./img/pigame-gallery/rolldice.PNG",
                            description:
                                "Rolling a dice gives the player ability to accumalate scores",
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description:
                                "Play wins if the score meets the race threshold",
                        },
                    ],
                ...
                },
                {
                    ...
                    urlProject:
                        "https://olaknowct.github.io/Array-Bankist/index.html",
                    demoVideo: {
                        isAvailable: false,
                        clipchamp: "https://clipchamp.com/watch/sYpbeA2kKFi",
                    },
                ...
                },
                {
                    ...
                    gallery: [
                        ...
                        },
                        {
                            ...
                            description:
                                "this is what happen when a japan is being clicked",
                        },
                        {
                            path: "./img/microflag-gallery/chnan.PNG",
                            description:
                                "China has a country neighbor, the smaller flag are the neighbor",
                        },
                    ],
                    urlProject:
                        "https://olaknowct.github.io/MicroFlag/index.html",
                    demoVideo: {
                        isAvailable: false,
                        clipchamp: "https://clipchamp.com/watch/sYpbeA2kKFi",
                    },
                ...
                },
                {
                    ...
                    shortDescription:
                        "is a deck of monster, monster rancher is a popular anime way back 2000s",
    ...
    render() {
        const portofolios = this.state.portfolios;
        return (
            <div className="cards fade-in">
                {portofolios.sort(this.compare).map((portfolio) => (
